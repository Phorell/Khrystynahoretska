(() => {
    ...
    (() => {
        ...
        const blogItems = document.querySelector(".projects__items");
        let data;
        let startItem = 0;
        let endItem = 6;
        ...
        function buildBlogItem(item) {
            ...
            blogItemTemplate += `<div data-id="${item.id}" class="projects__item">`;
            item.image ? blogItemTemplate += `<a target="_blank" href="${item.url}" class="projects__image">\n\t<img src="${item.image}" alt="Image">\n\t</a>` : null;
        ...
        function viewMore() {
            ...
            const currentItems = document.querySelectorAll(".projects__item").length;
            const vewMore = document.querySelector(".projects__view-more");
            currentItems < dataItemsLength ? vewMore.hidden = false : vewMore.hidden = true;
        }
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".projects__view-more")) {
                startItem = document.querySelectorAll(".projects__item").length;
                endItem = startItem + 6;
                initBlog(data, startItem, endItem);
                e.preventDefault();
            }
